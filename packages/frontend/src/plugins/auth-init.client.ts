...
/**
 * Client-side plugin: restore auth state from sessionStorage on every page load/refresh.
 *
 ...
 *
 * The `.client.ts` suffix ensures this only runs in the browser (sessionStorage is
